...
[![Download for Windows](https://img.shields.io/badge/Download-Windows-ff8a3d?style=for-the-badge&logo=windows&logoColor=white)](https://maestrus.cloud/downloads/maestrus-win-0.5.10.exe)
[![Download for macOS](https://img.shields.io/badge/Download-macOS-ff8a3d?style=for-the-badge&logo=apple&logoColor=white)](https://maestrus.cloud/downloads/maestrus-mac-0.5.10.dmg)
[![Download for Linux](https://img.shields.io/badge/Download-Linux-ff8a3d?style=for-the-badge&logo=linux&logoColor=white)](https://maestrus.cloud/downloads/Maestrus-0.5.10.AppImage)

<sub>Latest **v0.5.10** · [all releases](https://github.com/joaoventuri/maestrus/releases) · Apache-2.0 · no telemetry</sub>
...
**No account needed.** On the host, open *Remote Access → Pair without an
account*, hit **Generate invite**, and read the QR (or paste the code) on the
other device. The invite carries the relay address and a secret the two machines
share; the room is `sha256(secret)` and each side proves possession with an HMAC,
so the relay forwards traffic without ever learning the secret — or who you are.
Invites expire, and rotating the secret closes the room.
...
|---|---|---|---|
| <img src="https://cdn.simpleicons.org/windowsxp/ff8a3d" width="18"/> | **Windows** | [`maestrus-win-0.5.10.exe`](https://maestrus.cloud/downloads/maestrus-win-0.5.10.exe) | Installer · auto-updates |
| <img src="https://cdn.simpleicons.org/apple/ff8a3d" width="18"/> | **macOS** (Apple Silicon) | [`maestrus-mac-0.5.10.dmg`](https://maestrus.cloud/downloads/maestrus-mac-0.5.10.dmg) | Installer · auto-updates |
| <img src="https://cdn.simpleicons.org/linux/ff8a3d" width="18"/> | **Linux** | [`Maestrus-0.5.10.AppImage`](https://maestrus.cloud/downloads/Maestrus-0.5.10.AppImage) | Portable · `chmod +x` and run |
